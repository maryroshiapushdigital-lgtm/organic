...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      console.log(window.scrollY); // Adjust scroll threshold as needed
    };
    ...
    <div>
          ...
          <div className="features">
            ...
            <div className="feature">
              ...
              <div>
                ...
                <p className="head2">Grown by traditional farmers using time-honoured organic methods.</p>
              </div>
            </div>
            ...
            <div className="feature">
              ...
              <div>
                ...
                <p className="head2">Pure, simple foods that retain every gram of natural nutrition.</p>
              </div>
            </div>
            ...
            <div className="feature">
              ...
              <div>
                ...
                <p className="head2">Designed to nourish every generation — from children to elders.</p>
              </div>
            </div>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-col">
            ...
            <div className="para">
              <img src="/ph.png" alt="phone" />
              <p>
                Landline: (+91) 44 - 42633329<br />
                Mobile: (+91) 98402 64453
              </p>
            </div>
          ...
          <div className="footer-col">
            ...
            <div className="social-icons">
              ...
              <span>
                <img src="/inn.png" alt="instagram" />
              </span>
              <span>
                <img src="/fb.png" alt="facebook" />
              </span>
              <span>
                <img src="/u.png" alt="youtube" />
              </span>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <p>© 2026 Organic Heritage Grains. All rights reserved.</p>
          <p>Powered by Push Digital</p>
        </div>
      </footer>
